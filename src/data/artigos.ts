...
export const ARTIGOS: Artigo[] = [
  {
    ...
    conteudo: [
      ...
      "Nosso nome não é provocação gratuita. É um manifesto. Subverter, no sentido mais honesto da palavra, significa virar pelo avesso — enxergar o que está embaixo, o que foi enterrado, o que pulsa nas margens. É isso que buscamos em cada página: a voz que insiste em existir, a história que ainda não foi contada do jeito que merecia, a imagem que desestabiliza antes de iluminar.",
      "A Revista Subverso é um espaço para quem escreve com urgência e para quem lê com fome. Publicamos poesia, conto, crônica, ensaio, experimentação — tudo o que for capaz de fazer a linguagem suar, tremer, se reinventar. Não temos medo do inacabado, do híbrido, do que escapa às categorias.",
